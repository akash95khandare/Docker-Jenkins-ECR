#!/bin/bash
cd /home/ubuntu/chatapplication/;surce /home/ubuntu/venv/bin/activate;pip3 install gunicorn;pip3 install -r req.txt;pip3 install django;pip3 install channels;pip3 install django-environ;
echo 'DEBUG=TRUE
